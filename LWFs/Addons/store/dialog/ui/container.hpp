...
class PurchaseCheckbox: RscItemCheckboxGreen {
    ...
    tooltip = "$STR_LWFs_STORE_CHECKBOX_EQUIP";
	onCheckedChanged = "['button', ['enabled', []]] call LWFs_store_fnc_main;";
    colorBackground[] = {0, 0, 0, 0.7};
...
class PurchaseButton: RscItemButtonAction {
    ...
    text = "$STR_LWFs_STORE_BUTTON_PURCHASE";
    action = " ['button', ['pressed', []]] call LWFs_store_fnc_main;";
	sizeEx = FONT(1);
};