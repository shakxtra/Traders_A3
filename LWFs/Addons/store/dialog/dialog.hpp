...
class RscDisplayStore {
	...
	onLoad = "['onLoad', _this] call LWFs_store_fnc_main";
	onUnload = "['onUnload', _this] call LWFs_store_fnc_main";
	...
	class controls {
		class CloseButton: RscItemButtonClose {
			...
			action = "['onUnload'] call LWFs_store_fnc_main;";
			colorText[] = {1, 1, 1, 0.7};
			color[] = {1, 1, 1, 0.7};
		};
		...
		class LWFs_store_dialog: RscItemCtrlGroupNoScrollbars {
			idc = IDC_GROUP_ITEMS;
			x = DIALOG_X;
