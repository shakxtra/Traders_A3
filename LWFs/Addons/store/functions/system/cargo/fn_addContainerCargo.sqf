/*
	Function: LWFs_store_fnc_addContainerCargo
	Author: LWFs
...

{
    ...
    [_subContainer] call LWFs_store_fnc_clearContainerCargo;
    [_subContainer, _subData] call LWFs_store_fnc_addContainerCargo;
} forEach _containers;
