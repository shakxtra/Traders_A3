/*
	Function: LWFs_store_fnc_getContainerCargo
	Author: LWFs
	...
	Example:
	[_container] call LWFs_store_fnc_getContainerCargo;
...
private _everyContainer = everyContainer _container;
{
    ...
    _containerItems pushBack [_classname, _obj call LWFs_store_fnc_getContainerCargo];
